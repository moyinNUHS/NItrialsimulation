...
library(Hmisc); library(rms); library(gsDesign);library(ivpack); library(ggplot2) # Required libraries 
library(data.table); library(dplyr); library(plotly); library(ggpubr) 
...
simdata.bias<- function(n, i0, i1, p0, p1, confounder.eff.i,confounder.eff.o, confounder.u.eff.i,confounder.u.eff.o, nIterations){  
  ...
  # confounder.eff.o: effect of confounder on outcome;
  # confounder.u.eff.i: effect of confounder on intervention;
  # confounder.u.eff.o: effect of confounder on outcome;
  ...
  sim<- function() { 
    for(i in 1:interval) { print(paste ("interval value",i))
      for(l in 1:nIterations) { 
        ...
        odd0<-i0/(1-i0)                                       # Number of intervention=1 when C=0 R=0/ Number of intervention=0 when C=0 R=0
        ...
        odd3<-(i1/(1-i1))/(i0/(1-i0))                         # (Number of intervention=1 when R=1 / Number of intervention=0 when R=1) OVER
        ...
        p00.value<- mean((filter(simdata, intervention==0, randomisation==0))$outcome) #per protocol 
        p11.value<- mean((filter(simdata, intervention==1, randomisation==1))$outcome)
        
        pz1.value<- mean((filter(simdata, randomisation==1))$outcome)                  #intention to treat 
        pz0.value<- mean((filter(simdata, randomisation==0))$outcome)
        
        pd1.value<- mean((filter(simdata, intervention==1))$outcome)                   #as treated
...
#use scale -0.2 to 0 
bias1<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias2<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 1000000,  confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias3<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias4<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 1000000,  confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias5<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.45, i1=0.55, confounder.eff.i= 0.01,     confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias6<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.45, i1=0.55, confounder.eff.i= 0.01,     confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
biasfig1<-ggarrange(bias1, bias2, bias3, bias4, bias5, bias6, ncol = 3, nrow = 2,labels = c(paste(LETTERS[1:6], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(biasfig1, top = text_grob("Figure 3a. Varying effect of known confounder on outcome", face = "bold", size = 12))

######BIAS: Varying effect of unknown confounder on outcome########
bias7<-simdata.bias(n=300,  p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.0001, confounder.eff.o = 5,confounder.u.eff.i=0.01, confounder.u.eff.o=5,nIterations=1000)
bias8<-simdata.bias(n=300,  p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 10000,  confounder.eff.o = 5,confounder.u.eff.i=100,  confounder.u.eff.o=5,nIterations=1000)
bias9<-simdata.bias(n=300,  p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.001,  confounder.eff.o = 5,confounder.u.eff.i=0.001,confounder.u.eff.o=5,nIterations=1000)
bias10<-simdata.bias(n=300, p1=0.3, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 1000,   confounder.eff.o = 5,confounder.u.eff.i=1000, confounder.u.eff.o=5,nIterations=1000)
...
bias11<-bias1
bias12<-simdata.bias(n=300, p1=0.4, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
bias13<-simdata.bias(n=300, p1=0.5, p0=0.4, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
...
t1<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t2<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000000,  confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t3<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t4<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000000,  confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t5<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.01,     confounder.eff.o = 5,  confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t6<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.01,     confounder.eff.o = 0.2,confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
...
t7<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.0001, confounder.eff.o = 5,  confounder.u.eff.i=0.01, confounder.u.eff.o=5,nIterations=1000)
t8<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 10000,  confounder.eff.o = 5,  confounder.u.eff.i=100,  confounder.u.eff.o=5,nIterations=1000)
t9<-simdata.type1(n=200, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.01,   confounder.eff.o = 5,  confounder.u.eff.i=0.001,confounder.u.eff.o=5,nIterations=1000)
t10<-simdata.type1(n=200,p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000,   confounder.eff.o = 5,  confounder.u.eff.i=1000, confounder.u.eff.o=5,nIterations=1000)
...
t11<-simdata.type1(n=200, p1=0.3, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1, confounder.u.eff.o=1,nIterations=1000)
t12<-t3
t13<-simdata.type1(n=200, p1=0.5, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 5,  confounder.u.eff.i=1, confounder.u.eff.o=1,nIterations=1000)
...
#########Varying sample size ###############
t14<-simdata.type1(n=400, p1=0.4, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.01,        confounder.eff.o = 5,   confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
t15<-t5
t16<-simdata.type1(n=300, p1=0.4, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.01,        confounder.eff.o = 5,   confounder.u.eff.i=1,confounder.u.eff.o=1,nIterations=1000)
tfig4<-ggarrange(t15, t16, t14, ncol = 3, nrow = 1,labels = c(paste(LETTERS[1:3], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(tfig4, top = text_grob("Figure 4a. Varying sample size", face = "bold", size = 12))

##########POWER#########
########################
simdata.power<- function(n, p1, p0, confounder.eff.o, confounder.u.eff.i,confounder.u.eff.o, NImargin, nIterations){  
  # n: number of participants per group; 
  # p0: mortality and recurrences rate in intervention 0; 
  # p1: mortality and recurrences rate in intervention 1;
  # confounder.eff.o: effect of counfounder on outcome;
  # confounder.u.eff.i: effect of confounder on intervention;
  # confounder.u.eff.o: effect of confounder on outcome;
  ...
  if ((NImargin>0) & (p1-p0 < NImargin)) { #built with alternative hypothesis= pshort - plong > - NI 
    ...
    plot <- ggplot(sim.df, aes(sim.df[1]))+ 
      ...
      theme(legend.position="bottom")+
      theme(legend.title=element_blank())+
      scale_x_continuous(limits=c(0.67, 1))+
...
p1<-simdata.power(n=230, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(8/1)/(1/5) ,confounder.u.eff.i= 1 ,confounder.u.eff.o=1,nIterations=100)
p2<-simdata.power(n=300, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
p3<-simdata.power(n=300, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(2/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
pfig1<-ggarrange(p1, p2, p3, ncol = 3, nrow = 1,labels = c("A", "B","C"), common.legend = TRUE, legend = "bottom")
annotate_figure(pfig1, top = text_grob("Figure 1. Varying effect of known confounder on outcome", face = "bold", size = 12))

p4<-simdata.power(n=300,p1=0.4,p0=0.4,NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.05 ,confounder.u.eff.o=0.05,nIterations=1000)
p5<-simdata.power(n=300,p1=0.4,p0=0.4,NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.1 ,confounder.u.eff.o=0.1,nIterations=1000)
p6<-p2 
p7<-simdata.power(n=300, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 5 ,confounder.u.eff.o=5,nIterations=1000)
pfig2<-ggarrange(p4, p5, p6, p7, ncol = 2, nrow = 2,labels = c("A", "B","C","D"), common.legend = TRUE, legend = "bottom")
annotate_figure(pfig2, top = text_grob("Figure 2. Varying effect of unknown confounder", face = "bold", size = 12))

p8<-simdata.power(n=300, p1=0.2, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
p9<-p2
p10<-simdata.power(n=300, p1=0.6, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
pfig3<-ggarrange(p8,p9,p10, ncol = 3, nrow = 1,labels = c("A", "B","C"), common.legend = TRUE, legend = "bottom")
annotate_figure(pfig3, top = text_grob("Figure 3. Varying outcome rate in intervention and control groups", face = "bold", size = 12))

p11<-simdata.power(n=300, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
p12<-p2
p13<-simdata.power(n=400, p1=0.4, p0=0.4, NImargin=0.12, confounder.eff.o=(4/1)/(1/5), confounder.u.eff.i= 0.5 ,confounder.u.eff.o=0.5,nIterations=1000)
pfig4<-ggarrange(p11, p12, p13, ncol = 3, nrow = 1,labels = c("A", "B","C"), common.legend = TRUE, legend = "bottom")
annotate_figure(pfig4, top = text_grob("Figure 4. Varying sample size", face = "bold", size = 12))

##########GROUP SEQUENTIAL#########
###################################
simdata.gs<- function(n, p1, p0, NImargin, confounder.eff.o, confounder.u.eff.i,confounder.u.eff.o, nIterations){  
  # n: number of participants per group:
  ...
  if ((NImargin <0) & (p1-p0 > NImargin)) { #built with alternative hypothesis= pshort - plong > - NI 
    if (nIterations>1) {
      ...
      interval<-30 #number of data points in simulation 
...
gs1<-simdata.gs(n=300,p0=0.6, p1=0.6,confounder.eff.o=40, nIterations=250,confounder.u.eff.i= 0.05 ,confounder.u.eff.o=0.05,NImargin=-.12)  
annotate_figure(gs1, top = text_grob("Figure 1. Varying effect of unknown confounder", face = "bold", size = 12))

gs2<-simdata.gs(n=300,p0=0.6, p1=0.6,confounder.eff.o=20,nIterations=250,confounder.u.eff.i= 0.05 ,confounder.u.eff.o=0.05,NImargin=-.12) 
annotate_figure(gs2, top = text_grob("Figure 2. Varying effect of unknown confounder", face = "bold", size = 12))

gs3<-simdata.gs(n=300,p0=0.6, p1=0.6,confounder.eff.o=10,nIterations=250,confounder.u.eff.i= 0.05 ,confounder.u.eff.o=0.05,NImargin=-.12) 
