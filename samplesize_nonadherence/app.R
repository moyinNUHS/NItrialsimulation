...
ui <- shinyUI(
    navbarPage("Power calculator accounting for non-adherence in a non-inferiority trial",
               ...
               tabPanel("Introduction",
                        mainPanel(
                            h5("This is a power calculator based on simulations of a two-arm non-inferiority trial with dichotomaous outcome and time-fixed intervention."),
                            h4(),
                            h4("How to use"),
                            h6("1. Consider the potential factors which may cause non-adherence. Confounders are factors that affect both the adherence and the outcome.
                            ...
                            h6("2. Enter the number of participants per group that you would like to use to calculate power."),
                            h6("   3. Choose the non-inferiority margin."),
                            h6("   4. Choose the estimated proportion of adherent participants in each group."),
                            h6("   5. Choose the estimated proportion of participants with outcome in each group."),
                            h6("   6. Choose the level of significance."),
                            h6("   7. If the driver of non-adherence is by confounding factors, choose the confounder's direction of effect on adherence and outcome"),
                            h4(),
                            h4("Simulation mechanism"),
                            h6("Participants are randomised in a 1:1 ratio. Adherence to assigned treatment may be dependent or independent of patient characteristics.\n 
                            ...
                            h4(),
                            h4("Feedback"),
                            h6("Please contact Mo Yin (moyin@tropmedres.ac) to report any issues."),
                            h4(),
                            h4("Lastest update"),
                            h6(Sys.time()),
                            width = 20
