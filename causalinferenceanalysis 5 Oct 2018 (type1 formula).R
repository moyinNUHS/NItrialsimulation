...
#TYPE 1 ERROR
simdata.type1.1<- function(n, i0, i1, NImargin, p1, confounder.eff.i,confounder.eff.o, confounder.u.eff.i,confounder.u.eff.o, nIterations){  
...
#save graphs generated from simulations 
image_name <- paste0("case1.1", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))

#Run simulations for case 1.1
b1.1<-simdata.bias.1.1   (n=300, p1=0.4, p0=0.3, i0=0.01, i1=0.99, confounder.eff.i= 1, confounder.eff.o = 0, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
...
case1.1<-ggarrange(b1.1, t1.1, p1.1, ncol = 3, nrow = 1,labels = c(paste(LETTERS[1:3], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case1.1, top = text_grob("Non-compliance caused by random processes affecting both groups", face = "bold", size = 12))
dev.off()
...
#save graphs generated from simulations 
image_name <- paste0("case1.2", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))

#Run simulations for case 1.2
b1.2<-simdata.bias.1.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 1, confounder.eff.o = 0, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
...
case1.2<-ggarrange(b1.2, t1.2, p1.2, ncol = 3, nrow = 1,labels = c(paste(LETTERS[1:3], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case1.2, top = text_grob("Non-compliance caused by random processes affecting intervention or control group", face = "bold", size = 12))
dev.off()
...
#save graphs generated from simulations 
image_name <- paste0("case1.3", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))

#Run simulations for case 1.3
b1.3<-simdata.bias.1.3   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 1, confounder.eff.o = 0, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
...
case1.3<-ggarrange(b1.3, t1.3, p1.3, ncol = 3, nrow = 1,labels = c(paste(LETTERS[1:3], sep="")), common.legend = TRUE, legend = "bottom" )
            ...
            for(i in 1:interval) { print(paste ("interval value",i))
                for(l in 1:nIterations) {  
                    ...
                    tryCatch({ #allow the function to run in case of errors
                        ...
                        ivmodel<-ivreg(outcome ~ intervention, ~ randomisation, x=TRUE, data=simdata) 
                        eff.iv<-ivmodel$coef[2] 
                        se<-summary(ivmodel)$coefficients[2,2] 
                        CI.iv<-eff.iv + c(-1,1)*z*se
                        .type1.error.iv[l]<- CI.iv[2]<NImargin
...
#save graphs generated from simulations 
image_name <- paste0("case2.1", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))
...
b2.1<-simdata.bias.2   (n=300, p1=0.4, p0=0.3, i0=0.45, i1=0.55, confounder.eff.i= 0.5,     confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
t2.1<-simdata.type1.2  (n=300, p1=0.4, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.5, confounder.eff.o = 0.2, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
p2.1<- simdata.power.2 (n=300, p1=0.4, p0=0.3, NImargin=0.12, i0=0.45, i1=0.55, confounder.eff.i= 0.5, confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
## higher value of confounder makes intervention more likely, outcome more likely
b2.12<-simdata.bias.2   (n=300, p1=0.4, p0=0.3, i0=0.45, i1=0.55, confounder.eff.i= 2,     confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
...
b2.13<-simdata.bias.2   (n=300, p1=0.4, p0=0.3, i0=0.45, i1=0.55, confounder.eff.i= 0.5,     confounder.eff.o = -0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
...
b2.14<-simdata.bias.2   (n=300, p1=0.4, p0=0.3, i0=0.45, i1=0.55, confounder.eff.i= 2,     confounder.eff.o = -0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
...
case2.1<-ggarrange(b2.1, t2.1, p2.1, 
                   b2.12,t2.12,p2.12,
                   b2.13,t2.13,p2.13,
                   b2.14,t2.14,p2.14,
                   ncol = 3, nrow = 4,labels = c(paste(LETTERS[1:12], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case2.1, top = text_grob("Non-compliance caused by non-random processes affecting both groups", face = "bold", size = 12))
dev.off()

#save graphs generated from simulations 
image_name <- paste0("case2.2", "_",format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))

#Run simulations for case 2.2: Non-compliance caused by non random process (affect intervention groups)
b2.2<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
t2.2<-simdata.type1.2  (n=300, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 0.2, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
p2.2<- simdata.power.2 (n=300, p1=0.4, p0=0.3, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
b2.21<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 0.000001, confounder.eff.o = -0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
...
case2.2<-ggarrange(b2.2, t2.2, p2.2, 
                   b2.21, t2.21, p2.21, 
                   ncol = 3, nrow = 2,labels = c(paste(LETTERS[1:6], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case2.2, top = text_grob("Non-compliance caused by non-random processes affecting intervention group", face = "bold", size = 12))
dev.off()

#save graphs generated from simulations 
image_name <- paste0("case2.3", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))

#Run simulations for case 2.3: Non-compliance caused by non random process (affect control groups)
b2.3<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 1000000, confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
t2.3<-simdata.type1.2  (n=300, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000000, confounder.eff.o = 0.2, confounder.u.eff.i=1, confounder.u.eff.o=0, nIterations=1000)
p2.3<- simdata.power.2 (n=300, p1=0.4, p0=0.3, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000000, confounder.eff.o = 0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
b2.31<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 1000000, confounder.eff.o = -0.2,  confounder.u.eff.i=1,confounder.u.eff.o=0,nIterations=1000)
...
case2.3<-ggarrange(b2.3, t2.3, p2.3, 
                   b2.31, t2.31, p2.31, 
                   ncol = 3, nrow = 2,labels = c(paste(LETTERS[1:6], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case2.3, top = text_grob("Non-compliance caused by non-random processes affecting control group", face = "bold", size = 12))
dev.off()

#save graphs generated from simulations 
image_name <- paste0("case2.4", "_", format(Sys.time(), "%d%b%Y_%H%M%Z"), ".pdf")
pdf(image_name)
save.image(paste0(image_name, ".Rdata"))
...
b2.4<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 1000, confounder.eff.o = 0.1,  confounder.u.eff.i=1000,confounder.u.eff.o=0.1,nIterations=1000)
t2.4<-simdata.type1.2  (n=300, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000, confounder.eff.o = 0.1, confounder.u.eff.i=1000, confounder.u.eff.o=0.1, nIterations=1000)
p2.4<- simdata.power.2 (n=300, p1=0.4, p0=0.3, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 1000, confounder.eff.o = 0.1,  confounder.u.eff.i=1000,confounder.u.eff.o=0.1,nIterations=1000)
b2.41<-simdata.bias.2   (n=300, p1=0.4, p0=0.3,       i0=0.01, i1=0.99, confounder.eff.i= 100000000, confounder.eff.o = 0.2,  confounder.u.eff.i=0.01,confounder.u.eff.o=-0.1,nIterations=1000)
t2.41<-simdata.type1.2  (n=300, p1=0.4, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 100000000, confounder.eff.o = 0.2, confounder.u.eff.i=0.01, confounder.u.eff.o=-0.1, nIterations=1000)
p2.41<- simdata.power.2 (n=300, p1=0.4, p0=0.3, NImargin=0.12, i0=0.01, i1=0.99, confounder.eff.i= 100000000, confounder.eff.o = 0.2,  confounder.u.eff.i=0.01,confounder.u.eff.o=-0.1,nIterations=1000)
case2.4<-ggarrange(b2.4, t2.4, p2.4, 
                   b2.41, t2.41, p2.41, 
                   ncol = 3, nrow = 2,labels = c(paste(LETTERS[1:6], sep="")), common.legend = TRUE, legend = "bottom" )
annotate_figure(case2.4, top = text_grob("Non-compliance caused by non-random processes with undocumented confounders", face = "bold", size = 12))
dev.off()
