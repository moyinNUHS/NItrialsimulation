...
ui <- shinyUI(
  navbarPage("Power calculator accounting for non-adherence in a non-inferiority trial",
             ...
             tabPanel("Introduction",
                      mainPanel(
                        h6("This is a power calculator based on simulations of a non-inferiority trial with varying degrees of non-adherence."),
                        h4("Simulation mechanism"),
                        h6("A two-arm non-inferiority trial with n participants in each arm is simulated over 1000 iterations. Pre-defined treatment estimate must be less than the non-inferiority margin for the calculator to work. Otherwise, power values are reflected as NA. 
                           In each iteration, if the upper bound of the confidence interval is less than the non-inferiority margin, the iteration registers as true positive iteration. Power is equivalent to the proportion of true positive iterations"),
                        h4("How to use"),
                        h6("Consider the potential factors which may cause non-adherence. Confounders are factors that affect the likelihood of the participants taking up the study interventions as well as the outcome.
                           Factors that affect the likelihood of the partcipants taking up the intervention but do not affect the outcome are non-confounding. Choose the tabs above by considering the overall driver of non-adherence in the study."),
                        h4("Feedback"),
                        h6("Please contact ... to report any bugs or problems"),
                        h4("Last update"),
                        h6("13 May 2019 1118 BST"),
                        width = 20
                      )
             ),
             ...
             tabPanel("Non-confounding factors",
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          ...
                          p("Note: The expected proportion of participants to have outcome in experimental arm should not be more than that of the standard-of-care arm by non-inferiority margin or more")
                        )
                      )), 
