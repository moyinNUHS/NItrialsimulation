...
col.itt<- "#009E73" ; col.pp <- "#D55E00"; col.at<-  "#E69F00" ; col.iv<-  "#56B4E9"; col.mpp<- "#0072B2" ; col.ps<-  "#CC79A7"
...
b2.4<-simdata.bias.2   (n=300, p1=0.3, p0=0.4,       i0=0.01, i1=0.99, confounder.eff.i= 10, confounder.eff.o = 2,  confounder.u.eff.i=100000,confounder.u.eff.o=98,nIterations=200, interval = interval)
