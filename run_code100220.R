...
#                  90% power
#This requires 505 participants per arm 
...
#Run simulations for case 1: Non-adherence caused by non-confounding factors (affect both groups)
...
ggsave(filename = paste("case1.cross", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
...
#Run simulations for case 4:Non-adherence caused by unknown confounders 
...
ggsave(filename = paste("unknownmulti", Sys.Date(), ".jpeg"), width = width, height = height*2/3, units = "in")
...
case1.inf.S2b <- ggarrange(b1both.inf.S2b, t1both.inf.S2b,  ncol = 2, labels = c('A','B'), 
                     common.legend = TRUE, legend = "bottom" )
ggsave(filename = paste("case1.inf.S2b", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
...
S2c.cross <- ggarrange(b1both.S2c, t1both.S2c,  ncol = 2, labels = c('A','B'), 
                       common.legend = TRUE, legend = "bottom" )
ggsave(filename = paste("S2c.cross", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
#non adherent participants receive inferior treatment 
...
S2d.inf <- ggarrange(b1both.S2d, t1both.S2d,  ncol = 2, labels = c('A','B'), 
                     common.legend = TRUE, legend = "bottom" )
ggsave(filename = paste("S2d.inf", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
...
S2e.cross <- ggarrange(b1both.S2e, t1both.S2e,  ncol = 2, labels = c('A','B'), 
                   common.legend = TRUE, legend = "bottom" )
ggsave(filename = paste("S2e.cross", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
#non adherent participants receive inferior treatment 
...
S2f.inf <- ggarrange(b1both.S2f, t1both.S2f,  ncol = 2, labels = c('A','B'), 
                   common.legend = TRUE, legend = "bottom" )
ggsave(filename = paste("S2f.inf", Sys.Date(), ".jpeg"), width = width, height = height, units = c("in"))
